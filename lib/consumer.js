...
var $ = require('orecore-lib').util.preconditions;

var Script = require('orecore-lib').Script;
var Networks = require('orecore-lib').Networks;
var PrivateKey = require('orecore-lib').PrivateKey;
var PublicKey = require('orecore-lib').PublicKey;
var Address = require('orecore-lib').Address;
var _ = require('orecore-lib').deps._;
 ...
 *
 * @param {orecore.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {orecore.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {orecore.Transaction} the updated transaction
 */
