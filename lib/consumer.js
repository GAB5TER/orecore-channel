...
var $ = require('bitcore-lib-dash').util.preconditions;

var Script = require('bitcore-lib-dash').Script;
var Networks = require('bitcore-lib-dash').Networks;
var PrivateKey = require('bitcore-lib-dash').PrivateKey;
var PublicKey = require('bitcore-lib-dash').PublicKey;
var Address = require('bitcore-lib-dash').Address;
var _ = require('bitcore-lib-dash').deps._;
...
Consumer.prototype.validateRefund = function(refund) {
  ...
  var amount = refund.outputs[0].duffs;
...
/**
 * Increments the amount being paid by a given amount of duffs.
 * @return {bitcore.Transaction} the updated transaction
 */
Consumer.prototype.incrementPaymentBy = function(duffs) {
  this.paymentTx.updateValue(duffs);
  this.paymentTx.sign(this.commitmentKey);
